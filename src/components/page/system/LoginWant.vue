        ...
        <!-- <form action=""> -->
          <div class="big-contain" v-else>
            ...
            <div style="display:flex;justify-content:space-between;">
              <input class="inputCss" style="width:45%;" type="text" placeholder="验证码" v-model="forgetForm.vecode">
					  <button class="bbutton" style="width:35%;border-radius:10px" @click.prevent="register">获取</button>
            </div>
